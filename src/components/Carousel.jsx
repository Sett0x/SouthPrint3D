    ...
    <div className="mx-auto end-px relative">
      <div className="relative h-64 md:h-96 overflow-hidden rounded-lg">
        ...
        <button type="button" className="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer" onClick={goToPrevSlide}>
          <span className="inline-flex items-center justify-center w-10 h-10 rounded-full  bg-gray-800/30 hover:bg-gray-800/60 focus:ring-4 focus:ring-white focus:ring-gray-800/70 focus:outline-none">
